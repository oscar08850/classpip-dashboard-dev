...
import {  Nivel, Alumno, Equipo, Juego, JuegoDeCompeticion, Punto, TablaPuntosFormulaUno,
          ...
          JuegoDeCuestionarioSatisfaccion, AlumnoJuegoDeCuestionarioSatisfaccion, Rubrica, Evento } from '../../clases/index';
...
export class JuegoComponent implements OnInit {
  ...
  CrearJuegoEvaluacion() {
    ...
    this.peticionesAPI.CrearJuegoDeEvaluacion(juego).subscribe(res => {
      ...
      let evento: Evento = new Evento(1, new Date(), this.profesorId, undefined, undefined, this.juego.id, this.nombreDelJuego, "Juego De Evaluación");
