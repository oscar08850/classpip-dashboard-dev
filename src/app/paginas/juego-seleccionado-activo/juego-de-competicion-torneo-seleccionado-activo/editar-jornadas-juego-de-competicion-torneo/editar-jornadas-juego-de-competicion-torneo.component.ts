...
import { Alumno, Juego, Jornada, TablaJornadas } from '../../../../clases/index';
...
@Component({
  selector: 'app-editar-jornadas-juego-de-competicion-torneo',
  templateUrl: './editar-jornadas-juego-de-competicion-torneo.component.html',
  styleUrls: ['./editar-jornadas-juego-de-competicion-torneo.component.scss']
})
export class EditarJornadasJuegoDeCompeticionTorneoComponent implements OnInit {
  ...
  EditarJornada() {
    ...
    for ( let i = 0; i < this.dataSource.data.length; i++) {
      ...
      if (this.selection.isSelected(this.dataSource.data[i]))  {
        ...
        this.jornadas[i] = new Jornada (this.NuevaFecha, NuevoCriterio, this.jornadas[i].JuegoDeCompeticionTorneoId);
